  ...
  return (
    <div className="relative mt-10  border-b border-neutral-800 min-h-[800px]" id="features">
      <div className="text-center">
        <span className="bg-neutral-900 text-orange-500 rounded-full h-6 text-sm font-medium px-2 py-1 uppercase hover:text-white">
            features
        </span>
            ...
            <div key={index} className="w-full sm:1/2 lg:w-1/3">
               <div className="flex">
                <div className="flex px-2 h-10 w-14 bg-neutral-900 text-orange-700
                                 justify-center items-center rounded-full mx-3 hover:text-white hover:bg-orange-500 ">
                    {feature.icon}
                </div>
                <div>
